...
@section('content')
    <!-- start page -->
    <div class="card">                    
        <form action="{{ route('calendar.emp.index') }}" method="GET">
            @csrf
            <div class="row mt-3 px-3 g-3" style="justify-content: space-between;">
                ...
                <div class="col-lg-6">
                    ...
                    <a href="{{ route('calendar.emp.index') }}" class="btn btn-soft-danger waves-effect waves-light btn-sm"><i class="ri-refresh-line me-1 align-bottom"></i> Reset</a>
                </div>
                            ...
                            <div class="col-lg-3">
                                <div class="card card-h-100">
                                    <div class="card-body">
                                        ...
                                        <a href="{{ route('calendar.emp.download', $kode) }}" class="btn btn-primary w-100"><i class="ri-calendar-todo-fill align-bottom me-1"></i> Download Calendar</a>
