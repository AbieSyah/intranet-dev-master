...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Detail Employee</h4>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex justify-content-between">
                    <h3 class="card-title">Information Employee : {{ $employee->fullname ?? '' }}</h3>
                ...
                <div class="card-body">
                        ...
                        <div class="row gy-3">
                            ...
                            <div class="col-lg-4 col-sm-6 p-2">
                                ...
                                <div class="text-center">
                                    ...
                                    <!-- <img src="" style="width: 100px;display: none;" class="show-image">  -->
                  ...
                  <input type="hidden" name="remove_file" id="remove_file" value="">
                            ...
                            <div class="col-lg-4 col-sm-6 p-2">
                                ...
                                <input type="text" name="nik" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="NIK according"
                                style="text-transform: uppercase; Background-color: #eff2f7;"
                                value="{{ old('nik', $employee->nik ?? '') }}" readonly />
                            ...
                            <div class="col-lg-4 col-sm-6 p-2">
                                ...
                                style="text-transform: uppercase; Background-color: #eff2f7;"
                                value="{{ old('no_ktp', $employee->no_ktp ?? '') }}" readonly />
                                <!-- <small class="text-info">NIK according to ID card</small> -->
                            </div>

                            <div class="col-lg-4 col-sm-6 p-2">
                                <label class="required fw-semibold fs-6 mb-2">Full Name</label>
                                <input required type="text" name="fullname" placeholder="Full Name according to ID card"
                                    class="form-control form-control-solid mb-3 mb-lg-0"
                                    style="text-transform: uppercase; Background-color: #eff2f7;"
                                    value="{{ old('fullname', $employee->fullname ?? '') }}" readonly />
                            ...
                            <div class="col-lg-8 col-sm-12 p-2">
                                ...
                                <input required type="text" name="addressktp"
                                    class="form-control form-control-solid mb-3 mb-lg-0"
                                    placeholder="Address according to ID card"
                                    value="{{ old('addressktp', $employee->addressktp ?? '') }}"
                                    style="Background-color: #eff2f7;" readonly />
                            </div>

                            <div class="col-lg-4 col-sm-6 p-2">
                                <label class="required fw-semibold fs-6 mb-2">Birthplace</label>
                                <input required type="text" name="birthplace"
                                    class="form-control form-control-solid mb-3 mb-lg-0"
                                    value="{{ old('birthplace', $employee->birthplace ?? '') }}"
                                    placeholder="Birthplace according to ID card" style="Background-color: #eff2f7;"
                                    readonly />
                            </div>
                            ...
                            <div class="col-lg-4 col-sm-6 p-2">
                                ...
                                <input required type="date" name="birthdate" id="birthdate"
                                    class="form-control form-control-solid mb-3 mb-lg-0 @error('birthdate') is-invalid @enderror"
                            ...
                            <div class="col-lg-4 col-sm-6 p-2">
                                ...
                                <div class="form-check mb-2">
                                    <input class="form-check-input" type="radio" name="gender" value="Male"
                                        id="radio-1"
                                        {{ old('gender', $employee->gender ?? '') == 'Male' ? 'checked' : '' }} disabled>
                                ...
                                <div class="form-check mb-2">
                                    <input class="form-check-input" type="radio" name="gender" value="Female"
                                        id="radio-2"
                                        {{ old('gender', $employee->gender ?? '') == 'Female' ? 'checked' : '' }} disabled>
                            ...
                            <div class="col-lg-4 col-sm-6 p-2">
                                ...
                                <select disabled class="form-select select2" data-placeholder="Select Religion" name="religion" id="religion">
                                    <option></option>
                            ...
                            <div class="col-lg-4 col-sm-6 p-2">
                                ...
                                <select disabled class="form-select select2" data-placeholder="Select Marital Status" name="marital" id="marital">
                                    <option></option>
                            ...
                            <div class="col-lg-4 col-sm-6 p-2">
                                ...
                                <input required type="text" name="hp"
                                    class="form-control form-control-solid mb-3 mb-lg-0" placeholder="031XXXXXXX"
                                    value="{{ old('hp', $employee->hp ?? '') }}" style="Background-color: #eff2f7;"
                                    readonly />
                            </div>
                            ...
                            <div class="col-lg-8 col-sm-12 p-2">
                                ...
                                <input required type="text" name="domicile_address"
                                    class="form-control form-control-solid mb-3 mb-lg-0"
                                    placeholder="Employee Domicile"
                                    value="{{ old('domicile_address', $employee->domicile_address ?? '') }}"
                                    style="Background-color: #eff2f7;" readonly />
                            </div>

                            <div class="col-lg-4 col-sm-6 p-2">
                                <label class="fw-semibold fs-6 mb-2">Blood Type</label>
                                <select disabled name="blood_type" class="form-select select2" data-placeholder="Select Blood Type" data-allow-clear="true">
                                    <option></option>
                            ...
                            <div class="col-lg-4 col-sm-6 p-2">
                                ...
                                <input required type="date" name="joindate"
                                    class="form-control datepicker form-control-solid mb-3 mb-lg-0"
                                ...
                                @if ($employee->status == "PERMANENT")
                                    <div id="permanent-start-date-field">
                                        ...
                                        <input type="date" name="permanent_startdate" class="form-control datepicker form-control-solid mb-3 mb-lg-0"
                                            value="{{ old('permanent_startdate', $employee->permanent_startdate ?? '') }}" placeholder="Select Date" disabled />
                                    </div>
                                @elseif ($employee->status == "PROBATION" || $employee->status == "CONTRACT")
                                    <div id="contract-start-date-field">
                                        ...
                                        <input disabled type="date" name="contract_startdate" class="form-control datepicker form-control-solid mb-3 mb-lg-0"
                                        value="{{ old('contract_startdate', $employee->contract_startdate ?? '') }}" placeholder="Select Date" />
                                    </div>
                                @elseif ($employee->status == "OUTSOURCING")
                                    <div id="outsourcing-vendor-field">
                                        <label class="fw-semibold fs-6 mt-3">Outsourcing Vendor</label>
                                        <input disabled type="text" name="outsourcing_vendor" class="form-control form-control-solid mb-3 mb-lg-0"
                            ...
                            <div class="col-lg-4 col-sm-6 p-2">
                                ...
                                <input type="date" name="enddate"
                                    ...
                                    style="Background-color: #eff2f7;" disabled />
                                @if ($employee->status == 'CONTRACT' || $employee->status == 'PROBATION')
                                    <div id="contract-number-field">
                                        <label class="fw-semibold fs-6 mt-3">Contract Sequence</label>
                                        <select disabled class="form-select select2" data-placeholder="Select Contract Sequence"
                            ...
                            <div class="col-lg-4 col-sm-6 p-2">
                                ...
                                <div class="form-check mb-2">
                                    <input class="form-check-input" type="radio" name="status" value="PERMANENT"
                                        id="radio-3"
                                ...
                                <div class="form-check mb-2">
                                    <input class="form-check-input" type="radio" name="status" value="CONTRACT"
                                        id="radio-6"
                                ...
                                <div class="form-check mb-2">
                                    <input class="form-check-input" type="radio" name="status" value="PROBATION"
                                        id="radio-6"
                                ...
                                <div class="form-check mb-2">
                                    <input class="form-check-input" type="radio" name="status" value="TERMINATED"
                                        id="radio-6"
                                ...
                                @if (!empty($employee->reason))
                                    <div id="reason-field">
                                        <input type="text" name="reason"
                                            class="form-control form-control-solid mb-3 mb-lg-0"
                                            value="{{ old('reason', $employee->reason ?? '') }}" disabled
                                            placeholder="Reason for Terminated" />
                                    </div>
                                @endif
                            </div>
                            ...
                            <div class="col-lg-4 col-sm-6 p-2">
                                ...
                                <select class="form-select select2" data-placeholder="Select an option" name="area_id"
                                    id="area_id" required style="Background-color: #eff2f7;" disabled>
                                    <option></option>
                            ...
                            <div class="col-lg-4 col-sm-6 p-2">
                                ...
                                <select class="form-select select2" data-placeholder="Select an option"
                                    name="department_id" id="deparment_id" required style="Background-color: #eff2f7;"
                                    disabled>
                                    <option></option>
                            ...
                            <div class="col-lg-4 col-sm-6 p-2">
                                ...
                                <select class="form-select select2" data-placeholder="Select an option"
                                    name="work_location" id="work_location" required style="Background-color: #eff2f7;"
                                    disabled>
                                    <option></option>
                            ...
                            <div class="col-lg-4 col-sm-6 p-2">
                                ...
                                <select class="form-select select2" data-placeholder="Select an option" name="section_id"
                                    id="section_id" style="Background-color: #eff2f7;" disabled>
                                    <option></option>
                            ...
                            <div class="col-lg-4 col-sm-6 p-2">
                                ...
                                <select class="form-select select2" data-placeholder="Select an option"
                                    name="position_id" id="position_id" style="Background-color: #eff2f7;" disabled>
                                    <option></option>
                            ...
                            <div class="col-lg-4 col-sm-6 p-2">
                                ...
                                <select class="form-select select2" data-placeholder="Select an option" name="level_id"
                                    id="level_id" style="Background-color: #eff2f7;" disabled>
                                    <option></option>
                            ...
                            <div class="col-lg-4 col-sm-6 p-2">
                                ...
                                <select class="form-select select2" data-placeholder="Select an option"
                                    name="building_id" id="building_id" style="Background-color: #eff2f7;" disabled>
                                    <option></option>
                            ...
                            <div class="col-lg-4 col-sm-6 p-2">
                                ...
                                placeholder="XXXXX" style="Background-color: #eff2f7;" disabled
                            ...
                            <div class="col-sm-6 p-2">
                                ...
                                <select disabled name="tax_dependents" class="form-select select2" 
                            ...
                            <div class="col-lg-4 col-sm-6 p-2">
                                ...
                                <select name="last_education" class="form-select select2" data-placeholder="Select Last Education" disabled>
                                    <option></option>
                            ...
                            <div class="col-lg-12">
                                <hr>
                                <h3 class="fw-semibold fs-4 text-center">Employee Milestones</h3>
                            </div>
                            <div class="col-lg-12">
    ...
    @if ($countEval > 0 && Auth::user()->can('hrd.evaluation.read'))
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header align-items-center d-flex justify-content-between">
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                $('#table_evalhistory').DataTable({
                    ...
                    scrollX: true,
                    ajax: {
                        url: "{{ route('evaluation.done.getEvalHistory') }}",
                        data: {
