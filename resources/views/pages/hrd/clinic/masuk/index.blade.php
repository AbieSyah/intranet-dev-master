...
<div class="row">
  <div class="col-12">
    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
      <h4 class="mb-sm-0">Medicine In</h4>
  ...
  <div class="col-lg-12">
    <div class="card">
      <div class="card-header align-items-center d-flex">
          @can('hrd.clinic.masuk.create')
            <a href="{{ route('clinic.masuk.create') }}" class="btn btn-primary btn-label waves-effect waves-light" data-text="Add New Transaction">
      ...
      <div class="card-body">
        <table class="table table-striped bordered" id="table_in">
          <thead>
            <tr>
