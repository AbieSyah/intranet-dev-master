        ...
        <div class="card">
            <div class="card-body">                                        
                <div class="row mb-3">
                    ...
                    <div class="col-lg-6">
                        <a href="{{route('training.data.proggress.ptt.detail.verified.back')}}" class="btn btn-primary btn-label waves-effect waves-light float-end"><i class="ri-arrow-left-circle-line label-icon align-middle fs-16 me-2"></i> Back</a>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-lg-7">
                        ...
                        <div class="modal-content">
                            <div class="modal-body text-center p-5">
                                <div class="mt-4">
                                    ...
                                    <form id="form-approve" method="POST" action="{{ route('training.data.verification.proggress.ptt.store') }}">
                                        @csrf
                                        @method('put')
