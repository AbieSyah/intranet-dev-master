...
<body class="garis_tepi">
    ...
    <table style="width:100%; font-size: 10px; padding: 5px;">
        ...
        <tr>
            ...
            <td>
                @if($fkt->tipe == 'ptt')
                    Program Training Tahunan (PTT)
                @else
                    Program Training Insidentil (PTI)
                @endif
            </td>
        </tr>
    </table>
    <table class="isi">
        <thead>
            <tr>
                <th class="isi" colspan="8">Data Pengajuan Program Training</th>
                @if($arr_fkt->unique('tipe')->pluck('tipe')[0] == 'pti')
                <th class="isi" colspan="3">Data tambahan untuk pengajuan PTI</th>
                @endif
            </tr>
            <tr>
                ...
                @if($arr_fkt->unique('tipe')->pluck('tipe')[0] == 'pti')
                <th class="isi" style="width:10%">Provider</th>
                <th class="isi">Biaya</th>
                <th class="isi">Akomodasi</th>
                @endif
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td class="isi" style="text-align: center;">{{$qry_fkt->bulan_pelaksanaan ?? '-'}}</td>
                @if($qry_fkt->tipe == 'pti')
        ...
        <div id="left">
            <table class="ttd">
                <tr>
                    ...
                    @endif
                    <td class="ttd" style="text-align: center;">Disetujui oleh</td>
                </tr>
                <tr>
                    ...
                    {{-- <td class="ttd" height="60" align="center"></td> --}}
                    @endif
                    @if(!empty($link_qr_approval))
                    <td class="ttd" height="60" align="center"><img src="data:image/png;base64, {!! base64_encode(QrCode::size(80)->generate($link_qr_approval)) !!} "></td>
                    @else
                    <td class="ttd" height="60" align="center"></td>
                    @endif
                </tr>
                <tr>
                    ...
                    @if(!empty($link_qr_verified))
                    <td class="ttd" style="text-align: center;">MIZUKAMI, Tatsuhiro</td>
                    @endif
                    <td class="ttd" style="text-align: center;">SAKURAI, Fusayoshi</td>
                </tr>
                <tr>
                    ...
                    @if(!empty($link_qr_verified))
                    <td class="ttd" style="text-align: center; text-transform: uppercase;">Director / Junior Director</td>
                    @endif
                    <td class="ttd" style="text-align: center; text-transform: uppercase;">Presiden Direktur</td>
                </tr>
            </table>
        </div>
    </div>
