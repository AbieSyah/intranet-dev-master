    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">                                        
                ...
                <div class="table-responsive">                         
                    <table class="table table-striped bordered" id="table_fkt" style="width:100%;">
                        ...
                        <tbody>
                            ...
                            if($title == 'hrd' || $title == 'admin'){
                                $cek_jml = \App\Models\Trainingfkt::where('kode_judul', $fkt->kode_judul)->whereNull('date_penilai')->count();
                            }else{
                ...
                <div class="row mt-4">
                    <div class="col-lg-12">
                        <a href="#" data-id="{{$tahun_usulan}}" data-bs-toggle="modal" data-bs-target=".bs-notification-modal-center" class="btn btn-primary btn-label waves-effect waves-light float-end"><i class="ri-checkbox-line label-icon align-middle fs-16 me-2"></i> Submit</a>
                    </div>
                </div>
                @endif
                <!-- Notification Mr.Sakurai Modal -->
                            ...
                            <lord-icon src="https://cdn.lordicon.com/rhvddzym.json" trigger="loop" colors="primary:#0ab39c" class="avatar-xl"></lord-icon>
                                <div class="mt-1">
                                    ...
                                    <form id="form-notif" method="POST" action="{{ route('training.ptt.notification') }}">
                                        @csrf
                                        @method('put')
                                        <input type="hidden" name="tahun_usulan" id="tahun_usulan" value="{{$tahun_usulan}}">
                                        <input type="hidden" name="id_approval" id="id_approval" value="presiden">
