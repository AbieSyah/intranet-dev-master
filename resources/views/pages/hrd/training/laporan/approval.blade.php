...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">APPROVAL LAPORAN TRAINING</h4>

            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);">Approval Laporan</a></li>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">     
                <form id="Formlaporan" action="{{route('training.laporan.approval.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <div class="row mb-3">
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                            <a href="{{ route('training.laporan.index') }}" class="btn btn-primary btn-label waves-effect waves-light float-end"><i class="ri-arrow-left-circle-line label-icon align-middle fs-16 me-2"></i> Back</a>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-lg-3">
                    ...
                    <div class="row">
                        <div class="card-body p-4 border-top border-top-dashed">
                            ...
                            @else
                            <div class="mb-4">
                                <label for="no_4" class="form-label">4. Kolom Supervisor (atasan langsung)</label>
                                <label for="no_4" class="form-label">(Setelah menerima laporan hasil pelatihan, harapan atasan terhadap bawahannya untuk menindak lanjuti di masa yang akan datang)</label>
                                <div class="col-lg-10">
