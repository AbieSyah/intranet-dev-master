                ...
                <div class="col-lg-12">
                    <div class="card-header border-bottom-dashed p-4">
                        <div class="d-flex">
                            ...
                            <a href="{{ route('training.index') }}" class="btn btn-primary mb-4 btn-label waves-effect waves-light float-end"><i class="ri-arrow-left-circle-line label-icon align-middle fs-16 me-2"></i> Back</a>
                            </div>
                        </div>
                    </div>
                    <!--end card-header-->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="Form-training" action="{{ route('training.update') }}" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="row g-3">
...
<script type="text/javascript">
    $(document).ready(function() {
        let table = $('#table_training').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: "{{ route('training.detail', $kode) }}",
            columns: [{
                data: 'DT_RowIndex',
                name: 'DT_RowIndex',
...
<script>
    ...
    $('#table_training').on("click", ".view-btn", function() {
