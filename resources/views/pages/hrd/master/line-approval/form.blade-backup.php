                            ...
                            <div class="col-lg-6 p-2">
                                ...
                                <select required class="form-select select2" data-placeholder="Select an option"
                                    ...
                                    <option
                                        ...
                                        Evaluation</option>
                                    <option
                                        {{ old('approval_type', $lineapproval->approval_type ?? '') == 'Attendance' ? 'selected' : '' }}>
                                        Attendance</option>
                                    <option
                                        {{ old('approval_type', $lineapproval->approval_type ?? '') == 'Employee Requisition' ? 'selected' : '' }}>
                                        Employee Requisition</option>
                                    <option
                                        {{ old('approval_type', $lineapproval->approval_type ?? '') == 'Asset Disposal' ? 'selected' : '' }}>
                                        Asset Disposal</option>
                                </select>
                            </div>
            ...
            function toggleApprovalFields() {
                ...
                approvalFields.each(function(index) {
                    ...
                    if (approvalType === 'Evaluation') {
                        ...
                        showDrafter = false;
                    } else if (approvalType === 'Asset Disposal') {
                        if (approvalNumber > 3) {
                            showApproval = false;
                        }
                        $('.info-approval').removeClass('d-none');
                        $('#employee-filter-and-table').hide()
                        showDrafter = false;
                    } else {
...
                    `;
                ...
                if (employeeIds.length === 0 && approvalType !== 'Asset Disposal') {
