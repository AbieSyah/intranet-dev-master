    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                @can('hrd.master.contract.create')
                <button type="button" id="add-contract" class="btn btn-primary btn-label waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#modal" data-text="Add New Contract">
                <i class="ri-add-circle-line label-icon align-middle fs-16 me-2"> </i>Add New Contract
                </button>
                @endcan  
            ...
            <div class="card-body">
                <table class="table table-striped bordered" id="table_contract">
                <thead>
                    <tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
          <h5 class="modal-title" id="exampleModalgridLabel">Contract</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form id="form" action="{{ route('contract.store') }}" method="post">
          @csrf
          @method('post')
          <div class="row g-3">
              ...
              <div class="col-lg-12">
                <div>
                  ...
                  <input type="text" class="form-control" name="name" id="name" placeholder="Masukkan Nama Contract" value="" required>
                </div>
              </div><!--end col-->
              <div class="col-lg-12">
...
<div id="modal-delete" class="modal fade flip" tabindex="-1" aria-labelledby="flipModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content">
            <form class="form" action="{{ route('contract.destroy') }}" method="post">
                @csrf
                @method('DELETE')
                <div class="modal-header">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#table_contract').on("click", ".edit-btn", function() {
            var contractId = $(this).data("id");
            $.ajax({
            url: "{{ route('contract.form') }}",
            method: "GET",
            data: {
                id: contractId
            },
        ...
        $('#table_contract').on("click", ".delete-btn", function() {
            var contractId = $(this).data("id");
            $("#modal-delete").find("input[name='id']").val(contractId);
