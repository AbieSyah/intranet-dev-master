    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                @can('hrd.master.level.create')
                <button type="button" id="add-level" class="btn btn-primary btn-label waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#modal" data-text="Add New Level">
                <i class="ri-add-circle-line label-icon align-middle fs-16 me-2"> </i>Add New Level
                </button>
                @endcan  
            ...
            <div class="card-body">
                <table class="table table-striped bordered" id="table_level">
                <thead>
                    <tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
          <h5 class="modal-title" id="exampleModalgridLabel">Level</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form id="form" action="{{ route('level.store') }}" method="post">
          @csrf
          @method('post')
          <div class="row g-3">
              ...
              <div class="col-lg-12">
                <div>
                  ...
                  <input type="text" class="form-control" name="nama" id="nama" placeholder="Masukkan Nama Level" value="" required>
                </div>
              </div><!--end col-->
              <div class="col-lg-12">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#table_level').on("click", ".edit-btn", function() {
