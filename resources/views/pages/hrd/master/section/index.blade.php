    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                @can('hrd.master.section.create')
                <button type="button" id="add-section" class="btn btn-primary btn-label waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#modal" data-text="Add New Section">
                <i class="ri-add-circle-line label-icon align-middle fs-16 me-2"> </i>Add New Section
                </button>
                @endcan  
            ...
            <div class="card-body">
                <table class="table table-striped bordered" id="table_section">
                <thead>
                    <tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
          <h5 class="modal-title" id="exampleModalgridLabel">Section</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form id="form" action="{{ route('section.store') }}" method="post">
          @csrf
          @method('post')
          <div class="row g-3">
              ...
              <div class="col-lg-12">
                <div>
                  ...
                  <input type="text" class="form-control" name="nama" id="nama" placeholder="Masukkan Nama Section" value="" required>
                </div>
              </div><!--end col-->
              <div class="col-lg-12">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#table_section').on("click", ".edit-btn", function() {
