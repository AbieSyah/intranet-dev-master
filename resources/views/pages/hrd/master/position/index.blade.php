    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                @can('hrd.master.position.create')
                <button type="button" id="add-position" class="btn btn-primary btn-label waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#modal" data-text="Add New Position">
                <i class="ri-add-circle-line label-icon align-middle fs-16 me-2"> </i>Add New Position
                </button>
                @endcan  
            ...
            <div class="card-body">
                <table class="table table-striped bordered" id="table_position">
                <thead>
                    <tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
          <h5 class="modal-title" id="exampleModalgridLabel">Position</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form id="form" action="{{ route('position.store') }}" method="post">
          @csrf
          @method('post')
          <div class="row g-3">
              ...
              <div class="col-lg-12">
                <div>
                  ...
                  <input type="text" class="form-control" name="nama" id="nama" placeholder="Masukkan Position" value="" required>
                </div>
              </div><!--end col-->
              <div class="col-lg-12">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#table_position').on("click", ".edit-btn", function() {
