    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                @can('hrd.master.building.create')
                <button type="button" id="add-building" class="btn btn-primary btn-label waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#modal" data-text="Add New Building">
                <i class="ri-add-circle-line label-icon align-middle fs-16 me-2"> </i>Add New Organization
                </button>
                @endcan  
            ...
            <div class="card-body">
                <table class="table table-striped bordered" id="table_building">
                <thead>
                    <tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
          <h5 class="modal-title" id="exampleModalgridLabel">Organization</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form id="form" action="{{ route('building.store') }}" method="post">
          @csrf
          @method('post')
          <div class="row g-3">
              ...
              <div class="col-lg-12">
                <div>
                  ...
                  <input type="text" class="form-control" name="nama" id="nama" placeholder="Masukkan Nama Organization" value="" required>
                </div>
              </div><!--end col-->
              <div class="col-lg-12">
...
<div id="modal-delete" class="modal fade flip" tabindex="-1" aria-labelledby="flipModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content">
            <form class="form" action="{{ route('building.destroy') }}" method="post">
                @csrf
                @method('DELETE')
                <div class="modal-header">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#table_building').on("click", ".edit-btn", function() {
        ...
        $('#table_building').on("click", ".delete-btn", function() {
            var buildingId = $(this).data("id");
            $("#modal-delete").find("input[name='id']").val(buildingId);
