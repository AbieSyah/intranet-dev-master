...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">MEETING ROOM BOOKING</h4>

            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);">Booking Room</a></li>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-3 mb-2">
                            <a href="{{ route('booking-room.index') }}" class="btn btn-secondary btn-label waves-effect waves-light"><i class="ri-refresh-line label-icon align-middle me-2"></i> Refresh</a>
                            </div>
...
<div id="modal-edit-calendar" class="modal fade" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="Form-add" action="{{ route('booking-room.store') }}" method="post">
                @csrf
...
<div id="flipModalUpdate" class="modal fade" tabindex="-1" aria-labelledby="flipModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="Form-update" action="{{ route('booking-room.update') }}" method="post">
                @csrf
                <div class="modal-header p-3 bg-soft-info">
...
<div id="flipModalUpdateSeris" class="modal fade" tabindex="-1" aria-labelledby="flipModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="Form-update-series" action="{{ route('booking-room.update.series') }}" method="post">
                @csrf
                <div class="modal-header p-3 bg-soft-info">
...
<div id="flipModalDelete" class="modal fade flip" tabindex="-1" aria-labelledby="flipModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content">
            <form id="form-delete" action="{{ route('booking-room.delete') }}" method="post">
                @csrf
...
<div id="flipModalDeleteSeris" class="modal fade flip" tabindex="-1" aria-labelledby="flipModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content">
            <form id="form-delete-series" action="{{ route('booking-room.delete.series') }}" method="post">
                @csrf
                <div class="modal-header">
