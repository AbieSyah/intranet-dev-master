                ...
                <div>
                    <div class="d-flex">
                        ...
                        {{-- <ul class="nav nav-pills animation-nav profile-nav gap-2 gap-lg-3 gap-md-3 flex-grow-1"
                            role="tablist">
                            <li class="nav-item">
                                <a class="nav-link fs-14 {{ request()->is('profile-home') ? '' : 'active' }}"
                                    href="{{ route('profile.home') }}">
                                    Home
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link fs-14 {{ request()->is('profile/internal-rule') ? '' : '' }}"
                                    href="{{ route('profile.internal.rule') }}">
                                    Internal Rule
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link fs-14 {{ request()->is('profile/benefit') ? '' : '' }}"
                            ...
                            <li class="nav-item">
                                <a class="nav-link fs-14 {{ request()->is('profile/calendar') ? '' : '' }}"
                            ...
                            <li class="nav-item">
                                <a class="nav-link fs-14 {{ request()->is('profile/medical') ? '' : '' }}"
                                    href="{{ route('profile.medical') }}">
                                    Medical Checkup
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link fs-14 {{ request()->is('profile/pkb') ? '' : '' }}"
                                    href="{{ route('profile.pkb') }}">
                                    PKB
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link fs-14 {{ request()->is('profile/booking') ? '' : '' }}"
                            ...
                            @can('hrd.menu.profile')
                                <li class="nav-item">
                                    <a class="nav-link fs-14 {{ request()->is('profile/training') ? '' : '' }}"
                                                                ...
                                                                <div class="col-md-2 col-lg-4">
                                                                    <div class="search-box">
                                                                        <input type="text" class="form-control search"
                                                                            name="cari" id="search-task-options"
                                        ...
                                        <div class="card-body">
                                                        ...
                                                        <div class="row g-0">
                                                            ...
                                                            <div class="col-md-8">
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <div class="text-end">
                                                                        <a href="{{ route('profile.home.detail', encrypt($news->id)) }}"
                                                        ...
                                                        <div class="row g-0 mt-4">
                                                            ...
                                                            <div class="col-md-8">
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <div class="text-end">
                                                                        <a href="{{ route('home.detail', encrypt($news->id)) }}"
                                                                            class="link-primary fw-medium">Read More <i
                                                                                class="ri-arrow-right-line align-middle"></i></a>
                                                                    </div>
                                                                    @if (!empty($news->tanggal_news))
                                            ...
                                            @else
                                                <div class="text-center">
                                                    ...
                                                    <p class="text-muted">The information you are looking for was not
                                                        found.</p>
                                                </div>
                                            @endif
                                        </div>
                                            ...
                                            @foreach ($data_all as $key => $value)
                                                @if ($value['start'] >= $date_now)
                                                    @if ($value['className'] == 'bg-soft-success border-success')
                                                        <div
                                                            class='card ribbon-box border ribbon-fill shadow-none right mb-lg-3'>
                                                            <div class='card-body'>
                                                                <div class="ribbon ribbon-primary">New</div>
                                                                <div class='d-flex mb-3'>
                                                                    <div class='flex-grow-1'>
                                                                        <i
                                                                            class='mdi mdi-checkbox-blank-circle me-2 text-primary'></i>
                                                                        <span
                                                                            class='fw-medium'>{{ $value['dateup'] }}</span>
                                                                    </div>
