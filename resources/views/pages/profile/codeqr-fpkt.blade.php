                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" style="font-family: 'Roboto', sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                        ...
                                        <tr style="font-family: 'Roboto', sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                            <td class="content-block" style="font-family: 'Roboto', sans-serif; box-sizing: border-box; font-size: 15px; vertical-align: top; margin: 0; padding: 0 0 12px;" valign="top">
                                                ...
                                                <p style="font-family: 'Roboto', sans-serif; margin-bottom: 8px; color: #878a99;">{{$query->fpkt->peserta->fullname ?? '-'}}</p>
                                            </td>
                                        </tr>
                                        <tr style="font-family: 'Roboto', sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                            <td class="content-block" style="font-family: 'Roboto', sans-serif; box-sizing: border-box; font-size: 15px; vertical-align: top; margin: 0; padding: 0 0 12px;" valign="top">
                                                <h5 style="font-family: 'Roboto', sans-serif; margin-bottom: 3px;">Usulan Topik Training :</h5>
                                                <p style="font-family: 'Roboto', sans-serif; margin-bottom: 8px; color: #878a99;">{{$query->fpkt->judul_fpkt ?? '-'}}</p>
                                            </td>
                                        </tr>
                                        <tr style="font-family: 'Roboto', sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                            <td class="content-block" style="font-family: 'Roboto', sans-serif; box-sizing: border-box; font-size: 15px; vertical-align: top; margin: 0; padding: 0 0 12px;" valign="top">
                                                ...
                                                @endif 
                                                @if($query->type == 2)
                                                <p style="font-family: 'Roboto', sans-serif; margin-bottom: 8px; color: #878a99;">{{$query->fpkt->atasan->fullname ?? '-'}}</p>
                                                @endif
                                                @if($query->type == 3)
                                                <p style="font-family: 'Roboto', sans-serif; margin-bottom: 8px; color: #878a99;">{{$query->fpkt->atasan_dept->fullname ?? '-'}}</p>
                                                @endif
                                                @if($query->type == 4)
                                                <p style="font-family: 'Roboto', sans-serif; margin-bottom: 8px; color: #878a99;">{{$query->fpkt->bod1->fullname ?? '-'}}</p>
                                                @endif
                                                @if($query->type == 5)
                                                <p style="font-family: 'Roboto', sans-serif; margin-bottom: 8px; color: #878a99;">{{$query->fpkt->bod2->fullname ?? '-'}}</p>
                                                @endif
                                                @if($query->type == 6)
                                                <p style="font-family: 'Roboto', sans-serif; margin-bottom: 8px; color: #878a99;">{{$query->fpkt->hrd->fullname ?? '-'}}</p>
                                                @endif
                                            </td>
                                        </tr>
                                        <tr style="font-family: 'Roboto', sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
