    ...
    <div class="row">
        <div class="col-lg-12">
            <div>
                ...
                <!-- Navbar -->
                <div class="card mt-4">                    
                    <form action="{{ route('profile.calendar') }}" method="GET">
                        @csrf
                        <div class="row mt-3 px-3 g-3" style="justify-content: space-between;">
                            <div class="col-lg-3">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <select class="form-control select2" id="select_tahun" name="select_tahun">
                                        @if(!empty($from_year))
                                            @for( $i=$max; $i>=$min; $i--)
                                                @if($i == $from_year)
                            ...
                            <div class="col-lg-3">
                                ...
                                <a href="{{ route('profile.calendar') }}" class="btn btn-soft-danger waves-effect waves-light btn-sm"><i class="ri-refresh-line me-1 align-bottom"></i> Reset</a>
                            </div>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="card card-h-100">
                                                <div class="card-body">
                                                    ...
                                                    <a href="{{ route('profile.calendar.download',$kode) }}" class="btn btn-primary w-100"><i class="ri-calendar-todo-fill align-bottom me-1"></i> Download Calendar</a>
    ...
    var c = new Choices("#event-category", {
        ...
        E = new FullCalendar.Calendar(e, {
            ...
            eventClick: function(e) {
                ...
                //ajax view calendar
                $.ajax({
                    url: "{{ route('profile.calendar.view') }}",
                    type: "POST",
                    data: {
