                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">                                        
                                        <form id="Formfkt" action="{{route('profile.training.fkt.pti.update')}}" method="POST">
                                            @csrf
                                            @method('put')
                                            <div class="row mb-3">
                                                <div class="col-lg-6">
                                                    <h4 class="text-primary">Edit Formulir Kebutuhan Training (FKT)</h4>
                                                </div>
                                                <div class="col-lg-6">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-lg-6">
                                                    <input type="hidden" class="form-control form-control-sm" id="kode" name="kode" placeholder="Masukkan kode" value="{{$training_fkt->kode}}">
                                                    <input type="hidden" class="form-control form-control-sm" id="id_pemohon" name="id_pemohon" placeholder="Masukkan id" value="{{$training_fkt->pemohon->id}}">
                                                    <input type="hidden" class="form-control form-control-sm" id="date_pemohon" name="date_pemohon" value="{{$training_fkt->date_pemohon}}">
                                                    <input type="hidden" class="form-control form-control-sm" id="created_at" name="created_at" value="{{$training_fkt->created_at}}">
                                                    <input type="text" class="form-control form-control-sm" id="nama_pemohon" name="nama_pemohon" placeholder="Masukkan Nama" value="{{$training_fkt->pemohon->fullname}}" style="Background-color: #eff2f7;" readonly>
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <div class="col-lg-3">
                                                ...
                                                <div class="col-lg-6">
                                                    <input type="text" class="form-control form-control-sm" id="department" placeholder="Masukkan Departemen" value="{{$training_fkt->pemohon->department->name}}" style="Background-color: #eff2f7;" readonly>
                                                </div>
                                                <div class="col-lg-3">                                        
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-lg-2">
                                                    <div class="form-group">
                                                        <select class="form-control select2" id="tahun_usulan" name="tahun_usulan" required>
                                                            @for( $i=$max; $i>=$min; $i--)
                                                                @if($i == $training_fkt->tahun_usulan)
                                                ...
                                                <div class="col-lg-2">
                                                    <div class="form-group">
                                                        <select class="form-control select2" id="tahun_pelaksanaan" name="tahun_pelaksanaan" required>
                                                            @for( $i=$max; $i>=$min; $i--)
                                                                @if($i == $training_fkt->tahun_pelaksanaan)
                                                                <option value="{{ $i }}" selected>{{ $i }}</option>
                                                                @else
                                                                <option value="{{ $i }}">{{ $i }}</option>
                                                                @endif
                                                    ...
                                                    <select class="form-control form-control-sm select2 fs-12" name="id_checker"
                                                        ...
                                                        @foreach ($employees as $emp)
                                                            @if(!empty($emp->level->nama))
                                                                @if($training_fkt->id_checker == $emp->id)
                                                                <option value="{{ $emp->id }}" selected>{{ $emp->fullname }} -- {{$emp->department->name}} -- {{$emp->level->nama}}</option>
                                                                @else
                                                                <option value="{{ $emp->id }}">{{ $emp->fullname }} -- {{$emp->department->name}} -- {{$emp->level->nama}}</option>
                                                                @endif
                                                            @else
                                                                @if($training_fkt->id_checker == $emp->id)
                                                                    <option value="{{ $emp->id }}" selected>{{ $emp->fullname }} -- {{$emp->department->name}}</option>
                                                                @else
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-lg-6">
                                                    <textarea class="form-control" id="alasan_pti" name="alasan_pti" rows="3" required>{{$training_fkt->alasan_pti}}</textarea>
                                                </div>
                                            </div>
                                                        ...
                                                        <tbody id="newlink2">  
                                                            ...
                                                            @foreach($data_all as $key => $data)         
                                                                <tr id="1" class="produk">
                                                                    <th scope="row" class="produk-id">{{($loop->iteration)}}</th>
                                                                    <td class="text-start">
                                                                        <input type="hidden" id="nomor" name="no_urut[]" value="{{($loop->iteration)}}">
                                                                        <div class="mb-2">
                                                                            <div class="form-group">
                                                                                <select class="fs-12 form-control form-control-sm select2 @error('id_peserta') is-invalid @enderror" name="id_peserta-{{($loop->iteration)}}[]" id="peserta-{{($loop->iteration)}}" data-placeholder="Select Employee" multiple="multiple" required>
                                                                                    @foreach($data['id_peserta'][0] as $key_peserta => $val_peserta)
                                                                                        @foreach($employees as $employee)
                                                                                            @if($employee->id == $val_peserta)
                                                                    ...
                                                                    <td>
                                                                        <div class="mb-2">
                                                                            <div class="form-group">
                                                                                <select class="fs-12 form-control form-control-sm select2 @error('id_penilai') is-invalid @enderror" name="id_penilai-{{($loop->iteration)}}[]" id="id_penilai-{{($loop->iteration)}}" data-placeholder="Select Employee" required>
                                                                                    @foreach($data['id_penilai'][0] as $key_penilai => $val_penilai)
                                                                                        @foreach($employees as $employee)
                                                                                            @if(!empty($employee->level->nama))
                                                                                                @if($employee->id == $val_penilai)
                                                                                                <option value="{{ $employee->id }}" selected>{{ $employee->fullname }} -- {{$employee->department->name}} -- {{$employee->level->nama}}</option>
                                                                                                @else
                                                                                                <option value="{{ $employee->id }}">{{ $employee->fullname }} -- {{$employee->department->name}} -- {{$employee->level->nama}}</option>
                                                                                                @endif
                                                                                            @else
                                                                                                @if($employee->id == $val_penilai)
                                                                                                <option value="{{ $employee->id }}" selected>{{ $employee->fullname }} -- {{$employee->department->name}}</option>
                                                                                                @else
                                                                    ...
                                                                    <td>
                                                                        <div class="input-group mb-2">
                                                                            <input type="text" class="form-control form-control-sm" id="judul-{{($loop->iteration)}}" name="judul-{{($loop->iteration)}}[]" placeholder="Masukkan Pelatihan" value="{{$data['judul']}}" required>
                                                                        </div>
                                                                    </td>
                                                                    <td>
                                                                        <select class="form-select form-select-sm mb-2" id="jenis_pelatihan-{{($loop->iteration)}}" name="jenis_pelatihan-{{($loop->iteration)}}[]" required>
                                                                            <option selected value="">Open this select menu</option>
                                                                            @if($data['jenis_pelatihan'][0] == 'Online')
                                                                            <option value="Online" selected>Online</option>
                                                                            @else
                                                                            <option value="Online">Online</option>
                                                                            @endif
                                                                            @if($data['jenis_pelatihan'][0] == 'Offline')
                                                                    ...
                                                                    <td>
                                                                        <select class="form-select form-select-sm mb-2" id="sifat-{{($loop->iteration)}}" name="sifat-{{($loop->iteration)}}[]" required>
                                                                            <option selected value="">Open this select menu</option>
                                                                            @if($data['sifat'][0] == 'Skill Training')
                                                                            <option value="Skill Training" selected>Skill Training</option>
                                                                            @else
                                                                            <option value="Skill Training">Skill Training</option>
                                                                            @endif
                                                                            @if($data['sifat'][0] == 'Re-Training')
                                                                            <option value="Re-Training" selected>Re-Training</option>
                                                                            @else
                                                                            <option value="Re-Training">Re-Training</option>
                                                                            @endif
                                                                            @if($data['sifat'][0] == 'Cross Functional Training')
                                                                            <option value="Cross Functional Training" selected>Cross Functional Training</option>
                                                                            @else
                                                                            <option value="Cross Functional Training">Cross Functional Training</option>
                                                                            @endif
                                                                            @if($data['sifat'][0] == 'Team Training')
                                                                            <option value="Team Training" selected>Team Training</option>
                                                                            @else
                                                                    ...
                                                                    <td>
                                                                        <div>
                                                                            <textarea style="white-space: pre-line;" class="form-control form-control-sm" id="alasan-{{($loop->iteration)}}" name="alasan-{{($loop->iteration)}}[]" placeholder="Masukkan Alasan" rows="3" required>{{$data['alasan'][0]}}</textarea>
                                                                        </div>
                                                                    </td>
                                                                    <td>
                                                                        <select class="form-select form-select-sm mb-2" id="bulan_pelaksanaan-{{($loop->iteration)}}" name="bulan_pelaksanaan-{{($loop->iteration)}}[]" required>
                                                                            <option selected value="">Open this select menu</option>
                                                                            @if($data['bulan_pelaksana'][0] == 'Fleksibel')
                                                                            <option value="Fleksibel" selected>Fleksibel</option>
                                                                            @else
                                                                            <option value="Fleksibel">Fleksibel</option>
                                                                            @endif
                                                                            @if($data['bulan_pelaksana'][0] == 'Januari')
                                                                            <option value="Januari" selected>Januari</option>
                                                                            @else
                                                                            <option value="Januari">Januari</option>
                                                                            @endif
                                                                            @if($data['bulan_pelaksana'][0] == 'Februari')
                                                                            <option value="Februari" selected>Februari</option>
                                                                            @else
                                                                            <option value="Februari">Februari</option>
                                                                            @endif
                                                                            @if($data['bulan_pelaksana'][0] == 'Maret')
                                                                            <option value="Maret" selected>Maret</option>
                                                                            @else
                                                                            <option value="Maret">Maret</option>
                                                                            @endif
                                                                            @if($data['bulan_pelaksana'][0] == 'April')
                                                                            <option value="April" selected>April</option>
                                                                            @else
                                                                            <option value="April">April</option>
                                                                            @endif
                                                                            @if($data['bulan_pelaksana'][0] == 'Mei')
                                                                            <option value="Mei" selected>Mei</option>
                                                                            @else
                                                                            <option value="Mei">Mei</option>
                                                                            @endif
                                                                            @if($data['bulan_pelaksana'][0] == 'Juni')
                                                                            <option value="Juni" selected>Juni</option>
                                                                            @else
                                                                            <option value="Juni">Juni</option>
                                                                            @endif
                                                                            @if($data['bulan_pelaksana'][0] == 'Juli')
                                                                            <option value="Juli" selected>Juli</option>
                                                                            @else
                                                                            <option value="Juli">Juli</option>
                                                                            @endif
                                                                            @if($data['bulan_pelaksana'][0] == 'Agustus')
                                                                            <option value="Agustus" selected>Agustus</option>
                                                                            @else
                                                                            <option value="Agustus">Agustus</option>
                                                                            @endif
                                                                            @if($data['bulan_pelaksana'][0] == 'September')
                                                                            <option value="September" selected>September</option>
                                                                            @else
                                                                            <option value="September">September</option>
                                                                            @endif
                                                                            @if($data['bulan_pelaksana'][0] == 'Oktober')
                                                                            <option value="Oktober" selected>Oktober</option>
                                                                            @else
                                                                            <option value="Oktober">Oktober</option>
                                                                            @endif
                                                                            @if($data['bulan_pelaksana'][0] == 'November')
                                                                            <option value="November" selected>November</option>
                                                                            @else
                                                                            <option value="November">November</option>
                                                                            @endif
                                                                            @if($data['bulan_pelaksana'][0] == 'Desember')
                                                                    ...
                                                                    <td class="provider">
                                                                        <div class="form-group">
                                                                            <select class="form-control form-control-sm select2 vendor" name="id_vendor-{{($loop->iteration)}}[]" id="id_vendor-dropdown-{{($loop->iteration)}}" data-placeholder="Pilih Vendor">
                                                                                @foreach($vendors as $vendor)
                                                                                    @if($data['id_vendor'][0] == $vendor->id)
                                                                                    <option value="{{ $vendor->id }}" selected>{{ $vendor->nama }}</option>
                                                                                    @else
                                                                                    <option value="{{ $vendor->id }}">{{ $vendor->nama }}</option>
                                                                                    @endif
                                                                                @endforeach
                                                                                @if(empty($data['id_vendor'][0]))
                                                                        ...
                                                                        <div id="cek_provider-{{($loop->iteration)}}">
                                                                            <div class="form-group mt-3">
                                                                                <input type="text" class="form-control form-control-sm" id="vendor_other-{{($loop->iteration)}}" name="vendor_other-{{($loop->iteration)}}[]" placeholder="Masukkan Provider" value="{{$data['nama_vendor'][0]}}">
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    <td class="biaya">
                                                                        <div class="input-group input-group-sm">
                                                                            <span class="input-group-text">Rp</span><input type="text" class="form-control form-control-sm nominal" id="biaya_fkt-{{($loop->iteration)}}" name="biaya_fkt-{{($loop->iteration)}}[]" placeholder="Masukkan Biaya" value="{{$data['biaya_fkt'][0]}}">
                                                                        </div>
                                                                    </td>
                                                                    <td class="akomodasi">
                                                                        <label for="penginapan" class="form-label">a) Menginap: </label>
                                                                        <select class="form-select form-select-sm mb-2 inap" id="penginapan-{{($loop->iteration)}}" name="penginapan-{{($loop->iteration)}}[]" required>
                                                                            <option selected value="">Open this select menu</option>
                                                                            @if($data['penginapan'][0] == 'Ya')
                                                                            <option value="Ya" selected>Ya</option>
                                                                            @else
                                                                            <option value="Ya">Ya</option>
                                                                            @endif
                                                                            @if($data['penginapan'][0] == 'Tidak')
                                                                        ...
                                                                        <select class="form-select form-select-sm mb-2 transport" id="transportasi-{{($loop->iteration)}}" name="transportasi-{{($loop->iteration)}}[]" required>
                                                                            <option selected value="">Open this select menu</option>
                                                                            @if($data['transportasi'][0] == 'Ya')
                                                                            <option value="Ya" selected>Ya</option>
                                                                            @else
                                                                            <option value="Ya">Ya</option>
                                                                            @endif
                                                                            @if($data['transportasi'][0] == 'Tidak')                                                                            
                                                                            <option value="Tidak" selected>Tidak</option>
                                                                            @else
                                                                            <option value="Tidak">Tidak</option>
                                                                            @endif
                            ...
                            <fieldset id="set-3" class="wizard-fieldset">
                                <div id="md-pti">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="md_provider" id="md_provider" data-placeholder="Pilih Vendor">
                                            <option selected="true" value="" hidden></option>
                                            @foreach($vendors as $vendor)
                                                <option value="{{ $vendor->id }}">{{ $vendor->nama }}</option>
                                            @endforeach
...
<script>
    $(document).ready(function () {
        ...
        $.each(data_all, function(key,val) { 
            var nomor = key+1;
            var id_vendor = val.id_vendor[0];
            if(id_vendor == null){
                $('#cek_provider-'+nomor+'').show();
            }else{
                $('#cek_provider-'+nomor+'').hide();
            }
            $('#id_vendor-dropdown-'+nomor+'').on('change', function() {
                var vendor = this.value;
                if(vendor == 'other'){
                    $('#cek_provider-'+nomor+'').show();
                    $('#vendor_other-'+nomor+'').val(val.nama_vendor[0]);
                }else{
                    $('#cek_provider-'+nomor+'').hide();
                    $('#vendor_other-'+nomor+'').val('');
                }
            });
        });
    });
