                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <form id="Form-collective-approve" action="{{ route('profile.training.fpkt.pti.store') }}" method="post">
                                            @csrf
                                            @method('PUT')
                                            <div class="row mb-3">
                                                <!-- Info Validation -->
                                                        ...
                                                        <table class="table table-borderless fs-12" style="table-layout: fixed; width: 100%;">
                                                            <thead class="align-middle">
                                                                <tr class="table-active">
                                                                    ...
                                                                    <th scope="col" style="width: 8%; text-align: center;">Level Skill diisi oleh atasan langsung (Skala 1-5)<span class="text-danger">*</span> <i class="ri-information-line" data-bs-toggle="tooltip" data-bs-html="true" title="Tingkat Skill / Knowledge menurut penilaian atasan langsung"></i></th>
                                                                ...
                                                                @if($arr_fpkt->isNotEmpty())
                                                                    ...
                                                                    @foreach($arr_fpkt as $data_fpkt)
                                                                        <tr id="1" class="produk">
                                                                            ...
                                                                            <td>
                                                                                <div class="input-group mb-2">
                                                                                    <input type="number" class="form-control atasan" id="level_atasan-{{$loop->iteration}}" name="level_atasan-{{$loop->iteration}}[]" value="{{$data_fpkt->level_atasan}}" required>
                                                                                </div>
                                                                            </td>                
                                                                            <td>
                                                                                <div class="input-group mb-2">
                                                                            ...
                                                                            <td>
                                                                                <a href="javascript:avoid(0);" class="btn btn-soft-danger"><i class="ri-delete-bin-line"></i></a>
                                                                            </td>
                                                                        </tr>
                                                                    @endforeach
                                                                @endif
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table table-bordered border-secondary fs-12 table-nowrap">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <th scope="row">
                                                                        @if($fkt->id_penilai == $user->employee_id)
                                                                        <div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <button class="btn btn-primary float-end" id="btn-submit" name="action" value="collective_approve" type="submit">Submit</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
...
<script>
    $(document).ready(function() {
        $("#btn-submit").click(function() {
            $("#Form-collective-approve").submit(function () {
