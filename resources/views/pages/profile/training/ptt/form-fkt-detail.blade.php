                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">                                        
                                        <div class="row mb-3">
                                            <div class="col-lg-6">
                                            <h4 class="text-primary">Detail Formulir Kebutuhan Pelatihan (FKP)</h4>
                                            </div>
                                            <div class="col-lg-6">
                                                @if($fkt->id_penilai == $user->employee_id && $fkt->date_peserta != null)
                                                <a href="{{ route('profile.back.approve.fkt.ptt') }}" class="btn btn-primary btn-label waves-effect waves-light float-end"><i class="ri-arrow-left-circle-line label-icon align-middle fs-16 me-2"></i> Back</a>
                                                @else
                                        ...
                                        <div id="collectiveModal" class="modal fade" tabindex="-1" aria-labelledby="collectiveModalLabel" aria-hidden="true" style="display: none;">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{ route('profile.training.collective.ptt', encrypt($fkt->kode)) }}" method="GET">
                                                        @csrf
                                        ...
                                        <div id="collectiveApproveModal" class="modal fade" tabindex="-1" aria-labelledby="collectiveApproveModalLabel" aria-hidden="true" style="display: none;">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{ route('profile.training.collective.approve.ptt', encrypt($fkt->kode)) }}" method="GET">
                                                        @csrf
                                                        <div class="modal-body">
                                                            <div class="mb-3">
                                                            ...
                                                            @if($fpkt->isNotEmpty())
                                                                ...
                                                                <td>
                                                                    <div class="dropdown d-inline-block">
                                                                        ...
                                                                        <ul class="dropdown-menu dropdown-menu-end">
                                                                            <li><a href="{{ route('profile.training.fpkt.ptt', encrypt($qry_fkt->id)) }}" class="dropdown-item"><i class="ri-eye-2-line align-bottom me-2 text-muted"></i> Detail FPKT</a></li>
                                                                            <li><a href="{{ route('profile.training.fpkt.ptt.print', encrypt($qry_fkt->id)) }}" class="dropdown-item" target="_blank"><i class="ri-file-pdf-line align-bottom me-2 text-muted"></i> Print FPKT</a></li>
                                                                        </ul>
                                                                    </div>
                                                                </td>
                                                            ...
                                                            @else
                                                                <td>
                                                                    <div class="dropdown d-inline-block">
                                                                        ...
                                                                        <ul class="dropdown-menu dropdown-menu-end">
                                                                            <li><a href="{{ route('profile.training.fpkt.ptt', encrypt($qry_fkt->id)) }}" class="dropdown-item"><i class="ri-edit-line align-bottom me-2 text-muted"></i> Isi FPKT</a></li>
                                                                            <li><a href="{{ route('profile.training.fpkt.ptt.print', encrypt($qry_fkt->id)) }}" class="dropdown-item" target="_blank"><i class="ri-file-pdf-line align-bottom me-2 text-muted"></i> Print FPKT</a></li>
                                                                        </ul>
                                                                    </div>
                                                                </td>
                                                                        ...
                                                                        @if($fpkt->sum('level_peserta') > 0)
                                                                            <td>
                                                                                <div class="dropdown d-inline-block">
                                                                                    ...
                                                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                                                        <li><a href="{{ route('profile.training.fpkt.ptt', encrypt($qry_fkt->id)) }}" class="dropdown-item"><i class="ri-edit-line align-bottom me-2 text-muted"></i> Detail FPKT</a></li>
                                                                                        <li><a href="{{ route('profile.training.fpkt.ptt.print', encrypt($qry_fkt->id)) }}" class="dropdown-item" target="_blank"><i class="ri-file-pdf-line align-bottom me-2 text-muted"></i> Print FPKT</a></li>
                                                                                    </ul>
                                                                                </div>
                                                                            </td>
