                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">  
                                        <form id="Form-collective" action="{{ route('profile.training.fpkt.ptt.store') }}" method="post">
                                            @csrf
                                            @method('PUT')                                      
                                            <div class="row mb-3">
                                                <div class="col-lg-6">
                                                <h4 class="text-primary">Formulir Penilaian Kebutuhan Pelatihan (FPKP)</h4>
                                                </div>
                                                <div class="col-lg-6">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-lg-10">
                                                    ...
                                                    {{-- <div class="row">
                                                        ...
                                                        <div class="col-lg-7">
                                                            <table class="table table-sm table-nowrap fs-12">
                                                                <tbody>
                                                                    <tr>
                                                                        <td>{{$fkt->vendor->nama ?? $fkt->nama_vendor ?? '-'}}</td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-5">
                                                            <label for="jenis" class="form-label col-form-label col-form-label-sm">Vendor Pelatihan<span class="text-danger">*</span></label>
                                                        </div>
                                                        <div class="col-lg-7">
                                                            <table class="table table-sm table-nowrap fs-12">
                                                                <tbody>
                                                                    <tr>
                                                                        <td>
                                                                            <div class="form-group">
                                                                                <select class="form-control form-control-sm select2" name="id_vendor" id="id_vendor" data-placeholder="Pilih Vendor">
                                                                            ...
                                                                            <div id="cek_provider">
                                                                                <div class="form-group mt-3">
                                                                                    <input type="text" class="form-control form-control-sm" id="vendor_other" name="vendor_other" placeholder="Masukkan Vendor" value="">
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
