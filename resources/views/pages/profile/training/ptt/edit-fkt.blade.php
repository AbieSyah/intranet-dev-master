                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">                                        
                                        <form id="Formfkt" action="{{route('profile.training.fkt.ptt.update')}}" method="POST">
                                            @csrf
                                            @method('put')
                                            <div class="row mb-3">
                                                <div class="col-lg-6">
                                                    @if($training_fkt->status == 15 || $training_fkt->status == 16)
                                                    <h4 class="text-primary">Revise Formulir Kebutuhan Pelatihan (FKP)</h4>
                                                    @else
                                                    <h4 class="text-primary">Edit Formulir Kebutuhan Pelatihan (FKP)</h4>
                                                    @endif
                                                </div>
                                                <div class="col-lg-6">
                                                    <a href="{{ route('profile.back.fkt.ptt') }}" class="btn btn-primary btn-label waves-effect waves-light float-end"><i class="ri-arrow-left-circle-line label-icon align-middle fs-16 me-2"></i> Back</a>
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <div class="col-lg-3">
                                                        ...
                                                        <select class="form-control select2" id="tahun_usulan" name="tahun_usulan" required>
                                                            @if($periode->isNotEmpty())
                                                                @foreach($periode as $period)
                                                                    @if($period->periode == $training_fkt->tahun_pelaksanaan)
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-lg-6">
                                                    @if($training_fkt->status == 15 || $training_fkt->status == 16)
                                                        <input type="hidden" name="id_checker" id="id_checker" value="{{$training_fkt->id_checker}}">
                                                        <select class="form-control form-control-sm select2 fs-12" name="id_checker"
                                                            id="id_checker" data-placeholder="--Pilih Atasan--" required disabled>
                                            ...
                                            <div class="row" id="form-submit">
                                                <div class="col-lg-12">
                                                    <div class="hstack gap-2 d-print-none mt-4" style="justify-content: flex-end;">
                                                        @if($training_fkt->status == 15 || $training_fkt->status == 16)
                                                        <button class="btn btn-primary" id="btn-revise" name="action" value="revise" type="submit">Submit</button>
                                                        @else
