                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-body text-center p-5">
                                                        <div class="mt-2">
                                                            ...
                                                            <form id="form-approve" class="mt-4" method="POST" action="{{ route('profile.training.fkt.ptt.approved.store') }}">
                                                                @csrf
                                                                @method('put')
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-body text-center p-5">
                                                        <div class="mt-2">
                                                            ...
                                                            <form id="form-revise" class="mt-4" method="POST" action="{{ route('profile.training.fkt.ptt.revised.store') }}">
                                                                @csrf
                                                                @method('put')
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-body text-center p-5">
                                                        <div class="mt-2">
                                                            ...
                                                            <form id="form-reject" class="mt-4" method="POST" action="{{ route('profile.training.fkt.ptt.rejected.store') }}">
                                                                @csrf
                                                                @method('put')
