                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <a href="{{ route('recruitment.profile.index', ['tab_process_selection']) }}"
                                    ...
                                    <form class="form" id="selectionForm" action="{{ route('recruitment.profile.selection.review.store', ['token' => $token]) }}">
                                        @csrf
                                        <div class="row gy-3">
