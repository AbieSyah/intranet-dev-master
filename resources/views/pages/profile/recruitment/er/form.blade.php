                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <hr>
                                    <form id="FormER" action="{{ route('recruitment.profile.er.form.store') }}"
                                        method="POST">
                                        @csrf
                                        @method('POST')
                                        ...
                                        <div class="row">
                                            ...
                                            @for ($i = 1; $i <= $maxApprovals; $i++)
                                                @php
                                                    ...
                                                    $storedApprovalAs =
                                                        optional($er)->{$approvalAsKey} ?? $defaultApprovalAsText;
                                                ...
                                                <div class="row approval-group approval-group-{{ $i }}">
                                                    <div class="col-lg-3 col-sm-6 p-2">
                                                        ...
                                                        <input type="hidden" name="{{ $approvalIdKey }}"
                                                            id="{{ $approvalIdKey }}" value="{{ $currentApprovalId }}">
                                                    </div>
                                                    <div class="col-lg-3 col-sm-6 p-2">
                                                    ...
                                                    <div class="col-lg-3 col-sm-6 p-2">
                                                        <label class="required fw-semibold fs-6 mb-2">Approval
                                                            {{ $i }}
                                                            As</label>
                                                        <select id="{{ $approvalAsKey }}" name="{{ $approvalAsKey }}"
                                                            class="form-select" required>
                                                            <option value="" disabled
                                                                {{ is_null($currentApprovalAs) ? 'selected' : '' }}>Select
                                                                an option
                                                            </option>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 mb-2">
                                                ...
                                                <input type="number" min="1" class="form-control" id="needs"
                                                    name="needs" value="{{ old('needs', $er->needs ?? '') }}"
                                                    placeholder="Hanya Angka / Only Number" required>
                                            </div>
                                            <div class="col-lg-4 mb-2">
                                                <label class="form-label col-form-label">Jabatan / Position</label>
                                                <select class="form-select select2 select2-clear"
                                                    data-placeholder="Select an option" name="position_id"
                                                    id="position_id">
                                                    <option></option>
                                            ...
                                            <div class="col-lg-4 mb-2">
                                                ...
                                                <select class="form-select select2 select2-clear"
                                                    data-placeholder="Select an option" name="department_id"
                                                    id="department_id">
                                                    <option></option>
                                            ...
                                            <div class="col-lg-4 mb-2">
                                                ...
                                                <select class="form-select select2 select2-clear"
                                                    data-placeholder="Select an option" name="section_id"
                                                    id="section_id">
                                                    <option></option>
                                            ...
                                            <div class="col-lg-4 mb-2">
                                                ...
                                                <select class="form-select select2 select2-clear"
                                                    data-placeholder="Select an option" name="area_id" id="area_id">
                                                    <option></option>
                                            ...
                                            <div id="replacement-fields" class="col-lg-8 row m-0 p-0">
                                                ...
                                                <div class="col-lg-6 mb-2">
                                                    ...
                                                    <input type="text" class="form-control mt-2"
                                                        id="reason_replacement_other" name="reason_replacement_other"
                                                        value="{{ old('reason_replacement_other', $er->reason_replacement_other ?? '') }}"
                                                        placeholder="Example: Movement from Outsourcing to HPI"
                                                        style="display: none;">
                                                </div>
                                            </div>
                                            <div class="col-lg-4 mb-2">
                                                        ...
                                                        <div class="row align-items-center mb-1 education-item">
                                                            <div class="col-lg-4">
                                                                <div class="form-check">
                                                                    <input class="form-check-input education-checkbox"
                                                        ...
                                                        <div class="modal-dialog modal-dialog-top">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="submitModalLabel">Submit
                                                                        Employee
                                                                        Requisition</h5>
                                                                ...
                                                                <div class="modal-body text-center p-5">
                                                                    <p class="text-muted">Are you sure you want to submit
                                                                        this Employee
                                                                        Requisition?
                                                                    </p>
                                                                </div>
                                                                <div class="modal-footer">
                                                                    <button type="submit" name="status" value="SUBMIT"
                                                                        form="FormER" class="btn btn-primary">Yes,
                                                                        Submit</button>
