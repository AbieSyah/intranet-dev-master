                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <a href="{{ route('recruitment.profile.index', ['tab_result']) }}"
                                            ...
                                            <div id="gender-requirements-container">
                                                @foreach ($genders as $genderName)
                                                    @php
                                                        ...
                                                        $isChecked =
                                                            !is_null($needsCount) || old("gender_select.{$genderName}");
                                    ...
                                    @if (!empty($er->decision))
                                        <div class="row">
                                            <div class="col-12 mb-2">
                                                <h5 class="text-center text-primary">Informasi Tindak Lanjut / Follow-Up
                                                    Information</h5>
                                            </div>
                                            <div class="col-lg-6 mb-2">
                                                <label class="form-label col-form-label">Sumber Rekrutmen / Recruitment
                                                    Source</label>
                                                @php
                                                    $recSource = [
                                                    ...
                                                    $selectedOtherDetail =
                                                        $recruitSource->where('name', 'Others')->first()->pivot
                                                            ->other_detail ?? '';
                                                @endphp
                                                <div id="recruitment-source-container">
                                                    @foreach ($recSource as $rs)
                                                        ...
                                                        <div class="row align-items-center mb-1 recsource-item">
                                                            <div class="col-12">
                                                                <div class="form-check">
                                                                    <input class="form-check-input recsource-checkbox"
                                                                        type="checkbox" value="{{ $rs }}"
                                                            ...
                                                            @if ($rs === 'Others')
                                                                <div class="col-12 recsource-input-container"
                                                                    id="other-source-input-container"
                                                                    style="{{ $isChecked ? '' : 'display:none;' }}">
                                                                    <input type="text"
                                                                        class="form-control recsource-input mt-1"
