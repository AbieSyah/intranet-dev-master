            ...
            <div>
                <div class="d-flex">
                    ...
                    <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link fs-14 {{ request()->is('profile/benefit') ? '' : 'active' }}" href="{{route('profile.benefit')}}">
                                My Benefit
                            </a>
                        </li>
                        <li class="nav-item">
                                                                ...
                                                                <div class="d-flex mt-3">                                                    
                                                                    <div class="flex-grow-1 overflow-hidden">
                                                                        @if(!empty($benefit->id_internal_rule))
                                                                            ...
                                                                            {{--<a href="#" class="cek_rule" data-bs-toggle="modal" data-id="{{route('lampiran.rule', encrypt($benefit->id_internal_rule))}}" data-bs-target="#modal-benefit"><span class="badge badge-soft-success"><i class="ri-link align-bottom me-1"></i> Rule</span></a>--}}
                                                                        @else
                                                                        <h6 class="mb-0">{{$benefit->benefit}}</h6>
