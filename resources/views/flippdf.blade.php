...
<html>
  ...
  <head>
  <link rel="shortcut icon" href="/flip/images/KPK_Logo.svg">
  ...
  <script type="text/javascript">
      ...
      $(document).ready(function () {
          $("#read").flipBook({
            //Layout Setting
            pdfUrl:"{{asset('assets/flip/pdf/pdf.pdf')}}",
            lightBox:true,
            layout:3,
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-white fixed-top shadow-sm">
    <a class="navbar-brand" href="index.html">
      <img src="{{asset('assets/flip/images/logo.png')}}" alt="KPK LOGO" width="150">
    </a>
  </nav>
  <!-- End Of Navbar -->
  ...
  <section class="info" id="info">
    <div class="container">
      <div class="card shadow">
        <div class="row">
          <div class="col-md-3">
            <img src="{{asset('assets/flip/images/book2/1.jpg')}}" class="w-100 book-1">
          </div>
          <div class="col-md-7 mt-3">
            ...
            <div class="button">
              ...
              <a href="{{asset('assets/flip/pdf/pdf.pdf')}}" class="btn btn-primary mt-2 text-white" download>Unduh PDF <i class="fas fa-download fa-lg"></i></a>
            </div>
            <!-- Description -->
