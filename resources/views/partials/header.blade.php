            ...
            <div class="d-flex align-items-center">
                ...
                {{--<div class="dropdown ms-1 topbar-head-dropdown header-item">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img id="header-lang-img" src="{{  url('') }}/assets/images/flags/us.svg" alt="Header Language" height="20" class="rounded">
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="id" title="Indonesia">
                            <img src="{{  url('') }}/assets/images/flags/id.svg" alt="user-image" class="me-2 rounded" height="18">
                        ...
                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="ja" title="Japanese">
                            <img src="{{  url('') }}/assets/images/flags/jp.svg" alt="user-image" class="me-2 rounded" height="18">
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            @if(auth()->user()->employee && !empty(auth()->user()->employee->avatar) && \Storage::disk('public')->exists('avatars/'.auth()->user()->employee->avatar))
                            <img class="rounded-circle header-profile-user" src="{{ asset('storage/avatars/'.auth()->user()->employee->avatar) }}" alt="Header Avatar">
                            @else
                            <img class="rounded-circle header-profile-user" src="{{  url('') }}/assets/images/users/user-dummy-img.jpg" alt="Header Avatar">
                            @endif
                            <span class="text-start ms-xl-2">
                                <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">{{ Auth::user()->employee?->fullname ?? Auth::user()->name }}</span>
                                <span class="d-none d-xl-block ms-1 fs-12 text-muted user-name-sub-text">
                                    @if(Auth::user()->roles->pluck('name')->first() == 'Security')
                                        {{ Auth::user()->roles->pluck('name')->first() }}
                                    @else
                                        {{ Auth::user()->employee?->department?->name ?? 'DOCTOR' }} / {{ Auth::user()->roles->pluck('name')->first() }}
                                    @endif
                                </span>
                            </span>
                        </span>
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="{{route('disclaimer')}}"><i class="ri-shield-flash-fill text-muted fs-16 align-middle me-1"></i> <span class="align-middle">Privacy Policy</span></a>
