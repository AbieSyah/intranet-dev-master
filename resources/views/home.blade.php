                                    ...
                                    <div class="flex-grow-1">
                                        <form action="{{ route('search') }}" method="GET">
                                            <div class="hstack gap-2">
                                                ...
                                                <div class="col-md-2 col-lg-2 ms-auto"></div>
                        ...
                        <ul class="list-unstyled">
                            <li class="fw-semibold">
                                <p class="lh-lg">
                                    ...
                                    <a href="{{ route('myservice-desk.index') }}" target="_blank">IT SERVICE DESK</a>
                                    <br>
                                    <i class="fst-italic">
                                        If you need help from the INTRANET Site usage service, please report your complaint at 
                                        <a href="{{ route('myservice-desk.index') }}" target="_blank">IT SERVICE DESK</a> page
                                    </i>
                                </p>
                            </li>
                        </ul>       
