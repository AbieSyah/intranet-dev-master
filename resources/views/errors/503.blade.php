...
<head>
    ...
    <meta charset="utf-8" />
    <title>Maintenance | Intranet Hisamitsu Pharma Indonesia</title>
                        ...
                        <div class="text-center mt-sm-5 pt-4">
                            <div class="mb-5 text-white-50">
                                @php
                                    ...
                                    $showAlert  = $now->greaterThanOrEqualTo($alertStart) && $now->lessThanOrEqualTo($eventEnd);
                                ...
                                <h2 class="text-white text-uppercase">{{ $timeInfo }}</h2>
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy;
                                <script>document.write(new Date().getFullYear())</script> INTRANET Design & Develop by Information Technology Hisamitsu Pharma Indonesia
                            </p>
                        </div>
                    </div>
                </div>
