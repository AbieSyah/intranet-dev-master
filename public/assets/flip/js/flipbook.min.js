...
! function(M, L, C, a) {
    M.fn.flipBook = function(e) {
        ...
        deeplinkingPrefix: "",
        assets: {
            preloader: "/assets/flip/images/preloader.jpg')}}",
            overlay: "/assets/filp/images/overlay.png')}}",
            flipMp3: "/assets/flip/mp3/turnPage.mp3",
            spinner: "/assets/flip/images/spinner.gif')}}"
        },
        pdfUrl: null,
        ...
        btnOrder: ["currentPage", "btnFirst", "btnPrev", "btnNext", "btnLast", "btnZoomIn", "btnZoomOut", "btnRotateLeft", "btnRotateRight", "btnAutoplay", "btnSearch", "btnSelect", "btnBookmark", "btnThumbs", "btnPrint", "btnDownloadPages", "btnDownloadPdf", "btnSound", "btnExpand", "btnClose"],
        currentPage: {
            enabled: !0,
            title: "Current page",
            vAlign: "top",
