  ...
  BootstrapDualListbox.prototype = {
    init: function () {
      ...
      this.container = $('' +
        ...
        '       <i class="ri-checkbox-multiple-line align-middle me-1"></i> Select all' +
        '       <i></i>' +
        '     </button>' +
        '     <button type="button" class="btn move">' +
        '       <i class="ri-arrow-right-circle-line align-middle me-1"></i> Move' +
        '     </button>' +
        '   </div>' +
        ...
        '       <i class="ri-arrow-left-circle-line align-middle me-1"></i> Move' +
        '     </button>' +
        '     <button type="button" class="btn removeall">' +
        '       <i class="ri-checkbox-multiple-blank-line align-middle me-1"></i> Clear all' +
        '       <i></i>' +
        '     </button>' +
        '   </div>' +
        '   <select multiple="multiple"></select>' +
