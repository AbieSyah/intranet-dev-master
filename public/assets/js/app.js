! function() {
    ...
    function p(e) {
        document.getElementById("header-lang-img") && ("en" == e ? document.getElementById("header-lang-img").src = "/assets/images/flags/us.svg" : "id" == e ? document.getElementById("header-lang-img").src = "/assets/images/flags/id.svg" : "gr" == e ? document.getElementById("header-lang-img").src = "/assets/images/flags/germany.svg" : "it" == e ? document.getElementById("header-lang-img").src = "/assets/images/flags/italy.svg" : "ru" == e ? document.getElementById("header-lang-img").src = "/assets/images/flags/russia.svg" : "ch" == e ? document.getElementById("header-lang-img").src = "/assets/images/flags/china.svg" : "ja" == e && (document.getElementById("header-lang-img").src = "/assets/images/flags/jp.svg"), localStorage.setItem("language", e), null == (y = localStorage.getItem("language")) && p(b), (e = new XMLHttpRequest).open("GET", "/assets/lang/" + y + ".json"), e.onreadystatechange = function() {
            var a;
